...
const ResultCharts = (results) => {
  ...
  return (
    <div>
      <h3>Resultats générals</h3>
      <Tooltip title={`${result.percAnswer1}% choix 1 - ${result.percAnswer2}% choix 2`}>
        <Progress successPercent={result.percAnswer1} showInfo={false} />
      </Tooltip>
      <h3>Resultats pour les hommes</h3>
      <Tooltip title={`${result.percMenAnswer1}% choix 1 - ${result.percMenAnswer2}% choix 2`}>
        <Progress successPercent={result.percMenAnswer1} showInfo={false} />
      </Tooltip>
      <h3>Resultats pour les femmes</h3>
      <Tooltip title={`${result.percWomenAnswer1}% choix 1 - ${result.percWomenAnswer2}% choix 2`}>
