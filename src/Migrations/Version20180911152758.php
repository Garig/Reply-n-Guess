...
final class Version20180911152758 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, departements_id INT DEFAULT NULL, roles_id INT DEFAULT NULL, is_validate TINYINT(1) NOT NULL, username VARCHAR(60) NOT NULL, password VARCHAR(100) NOT NULL, email VARCHAR(255) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, birth_date VARCHAR(15) NOT NULL, gender VARCHAR(10) NOT NULL, score INT DEFAULT NULL, INDEX IDX_8D93D6491DB279A6 (departements_id), INDEX IDX_8D93D64938C751C4 (roles_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE answer ADD CONSTRAINT FK_DADD4A2567B3B43D FOREIGN KEY (users_id) REFERENCES user (id)');
