...
(1, 'Gérard', '$2y$10$k5Xl4Rs0N.CXwW7IBYp8ze4IgU1GxE4NXbWxNq0Ds9S28SqzUxnCC', 'gerard@oclock.io', '01/01/1999', 'homme', 0, 1, 75, 0, 0, 0),
(1, 'Camille', '$2y$10$k5Xl4Rs0N.CXwW7IBYp8ze4IgU1GxE4NXbWxNq0Ds9S28SqzUxnCC', 'camille@oclock.io', '01/01/1999', 'femme', 0, 1, 49, 0, 0, 0),
(1, 'usernameX', '$2y$10$k5Xl4Rs0N.CXwW7IBYp8ze4IgU1GxE4NXbWxNq0Ds9S28SqzUxnCC', 'emailX@oclock.io', '01/01/1999', 'homme', 0, 1, 03, 0, 0, 0),
(1, 'usernameY', '$2y$10$k5Xl4Rs0N.CXwW7IBYp8ze4IgU1GxE4NXbWxNq0Ds9S28SqzUxnCC', 'emailY@oclock.io', '01/01/1999', 'femme', 0, 1, 18, 0, 0, 0),
(1, 'admintest', '$2y$13$RK16q4E32Ck6R07l0ePFnOfZjfv/Nmux24wBJbdXedb.mObnMmmfy', 'admintest@admin.test', '01/01/1999', 'homme', 0, 3, 16, 0, 0, 0);
...
INSERT INTO `result` (`nb_voting`, `nb_answer_1`, `nb_answer_2`, `nb_predict_1`, `nb_predict_2`, `perc_answer_1`, `perc_answer_2`, `perc_predict_1`, `perc_predict_2`, `perc_men_answer_1`, `perc_men_answer_2`, `perc_women_answer_1`, `perc_women_answer_2`, `perc_predict_accuracy`) VALUES
...
(3,'Quand tu dors, ta chambre est ?','Complètement noire','Pas complètement', timestamp('2018-10-01 14:53:27') - INTERVAL FLOOR( RAND( ) * 366) DAY, 0, 2, 12),
...
(4,'Pokemon ou Yu-Gi-Oh ?','Pokemon','Yu-Gi-Oh', timestamp('2018-10-01 14:53:27') - INTERVAL FLOOR( RAND( ) * 366) DAY, 0, 2, 22),
...
(3,'Préféreriez vous savoir lire dans les pensées ou être invisible ?','Lire dans les pensées','Être invisible', timestamp('2018-10-01 14:53:27') - INTERVAL FLOOR( RAND( ) * 366) DAY, 0, 2, 27),
...
(3,"Avez déjà fait semblant d’être malade pour éviter de faire quelque chose ?",'Oui','Non', timestamp('2018-10-01 14:53:27') - INTERVAL FLOOR( RAND( ) * 366) DAY, 0, 2, 31),
...
(1,'Être sujet d’une téléréalité toute sa vie ou que personne ne se souvienne de vous ?','Sujet d’une téléréalité','Aucun souvenir de moi', timestamp('2018-10-01 14:53:27') - INTERVAL FLOOR( RAND( ) * 366) DAY, 0, 2, 34),
...
(5,'Préféreriez vous être mortel dans un monde d’immortel ou immortel dans un monde de mortel ?','Mortel','Immortel', timestamp('2018-10-01 14:53:27') - INTERVAL FLOOR( RAND( ) * 366) DAY, 0, 2, 38),
...
(3,'Être le meilleur dans une équipe de mauvais ou le pire dans une équipe de bon ?','Le meilleur','Le pire', timestamp('2018-10-01 14:53:27') - INTERVAL FLOOR( RAND( ) * 366) DAY, 0, 2, 45),
...
(2,'Ketchup ou mayo ?','Ketchup','Mayo', timestamp('2018-10-01 14:53:27') - INTERVAL FLOOR( RAND( ) * 366) DAY, 0, 2, 47),
(2,"Marcher sur l’eau ou respirer sous l’eau ?","Marcher sur l’eau","Respirer sous l’eau", timestamp('2018-10-01 14:53:27') - INTERVAL FLOOR( RAND( ) * 366) DAY, 0, 2, 48);
